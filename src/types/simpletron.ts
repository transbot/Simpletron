...
export const getExamplePrograms = (language: Language) => {
  ...
  return {
    ...
    findMax: [
      ...
      `+4106  // ${t.examples.findMax.branchIfNeg}`,
      `+4010  // ${t.examples.findMax.loop}`,
