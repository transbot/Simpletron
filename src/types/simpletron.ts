...
export const getExamplePrograms = (language: Language) => {
  ...
  return {
    ...
    findMax: [
      `+0000  // ${t.examples.findMax.initZero}`,
      "+0000",
      `+1020  // ${t.examples.findMax.readCount}`,
      `+2020  // ${t.examples.findMax.loadCount}`,
      `+4217  // ${t.examples.findMax.branchIfZero}`,
      `+2119  // ${t.examples.findMax.storeCounter}`,
      `+1021  // ${t.examples.findMax.readFirst}`,
      `+2021  // ${t.examples.findMax.loadFirst}`,
      `+2118  // ${t.examples.findMax.storeMax}`,
      `+2019  // ${t.examples.findMax.loadCounter}`,
      `+3122  // ${t.examples.findMax.subtract1}`,
      `+2119  // ${t.examples.findMax.storeNewCounter}`,
      `+2019  // ${t.examples.findMax.loadCounter}`,
      `+4217  // ${t.examples.findMax.branchIfDone}`,
      `+1021  // ${t.examples.findMax.readNext}`,
      `+2018  // ${t.examples.findMax.loadMax}`,
      `+3121  // ${t.examples.findMax.subNew}`,
      `+4108  // ${t.examples.findMax.branchIfNeg}`,
      `+4012  // ${t.examples.findMax.loop}`,
      `+1118  // ${t.examples.findMax.writeMax}`,
      ...
      `+0000  // ${t.examples.findMax.tempNumber}`,
