...
export const getExamplePrograms = (language: Language) => {
  ...
  return {
    ...
    findMax: [
      `+1020  // ${t.examples.findMax.readFirst}`,
      `+1021  // ${t.examples.findMax.readSecond}`,
      `+2020  // ${t.examples.findMax.loadFirst}`,
      `+3121  // ${t.examples.findMax.subSecond}`,
      `+4107  // ${t.examples.findMax.branchIfSecondLarger}`,
      `+1120  // ${t.examples.findMax.writeFirst}`,
      `+4300  // ${t.examples.findMax.halt}`,
      `+1121  // ${t.examples.findMax.writeSecond}`,
      `+4300  // ${t.examples.findMax.halt2}`,
      `+0000  // ${t.examples.findMax.firstNumber}`,
      `+0000  // ${t.examples.findMax.secondNumber}`,
      "-99999"
    ]
  };
};