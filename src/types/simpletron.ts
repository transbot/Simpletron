...
export const getExamplePrograms = (language: Language) => {
  ...
  return {
    ...
    findMax: [
      ...
      `+3125  // ${t.examples.findMax.subtract1}`,
      `+2101  // ${t.examples.findMax.storeOriginalCount}`,
      ...
      `+2001  // ${t.examples.findMax.loadOriginalCount}`,
      `+3125  // ${t.examples.findMax.subtract1}`,
      `+2102  // ${t.examples.findMax.storeRemainingCount}`,
      `+2002  // ${t.examples.findMax.loadRemainingCount}`,
      ...
      `+4121  // ${t.examples.findMax.branchIfNewIsLarger}`,
      `+1100  // ${t.examples.findMax.writeMax}`,
      `+4300  // ${t.examples.findMax.halt}`,
      `+2010  // ${t.examples.findMax.loadNew}`,
      `+2100  // ${t.examples.findMax.updateMax}`,
      `+2002  // ${t.examples.findMax.loadRemainingCount}`,
      `+3125  // ${t.examples.findMax.subtract1Again}`,
      `+2102  // ${t.examples.findMax.storeNewRemainingCount}`,
