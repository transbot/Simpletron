  ...
  zh: {
    ...
    examples: {
      ...
      findMax: {
        ...
        subtract1: '减去1（因为第一个数字作为初始最大值）',
        storeCounter: '存储剩余计数器到地址01',
  ...
  en: {
    ...
    examples: {
      ...
      findMax: {
        ...
        subtract1: 'Subtract 1 (since first number becomes initial max)',
        storeCounter: 'Store remaining counter to address 01',
