  ...
  zh: {
    ...
    examples: {
      ...
      findMax: {
        ...
        storeCounter: '存储计数器到地址21',
        readFirst: '读取第一个数字到地址22',
        loadFirst: '加载该数字到累加器',
        storeMax: '存储为当前最大值到地址18',
        loadCounter: '加载计数器',
        subtract1: '减去1（地址23存储常量1）',
        storeNewCounter: '存储新的计数器值',
        branchIfDone: '如果为0（所有数字已处理完毕），跳转到17',
        readNext: '读取下一个数字到地址22',
        loadMax: '加载当前最大值',
        subNew: '减去新数字',
  ...
  en: {
    ...
    examples: {
      ...
      findMax: {
        ...
        storeCounter: 'Store counter to address 21',
        ...
        loop: 'Branch to 10 to continue loop',
